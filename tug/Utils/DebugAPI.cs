...
namespace IngameScript.Logging {
    ...
    //Digi's DebugAPI: https://steamcommunity.com/sharedfiles/filedetails/?id=2654858862
    public class DebugAPI {
        ...
        public static DebugAPI INSTANCE { get; private set; }
        public static void Create(MyGridProgram program, bool drawOnTopDefault = false) {
            INSTANCE = new DebugAPI(program, drawOnTopDefault);
        }
        private DebugAPI(MyGridProgram program, bool drawOnTopDefault = false) {
            if (program == null)
